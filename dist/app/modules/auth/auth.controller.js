...
const credentialsLogin = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { user, accessToken, refreshToken } = yield auth_service_1.AuthServices.credentialsLogin(req.body);
...
const resetPassword = (0, catchAsync_1.catchAsync)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!decodedToken) {
        throw new AppError_1.default(http_status_codes_1.default.UNAUTHORIZED, "Unauthorized: No user token found");
    }
